                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            @error('images.*')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                            <p class="mt-1 text-sm text-gray-500">Upload one or more screenshots or mockups of your project (JPG, PNG, GIF, SVG, WebP - max 5MB each, up to 10 images). The first image will be used as the preview on the welcome page.</p>
                        </div>
