...
<div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 mb-6 lg:mb-8">
    <div>
        <h1 class="text-2xl lg:text-3xl font-bold text-gray-900">Create New Skill</h1>
        <p class="text-gray-600 mt-1">Name a skill, pick its logo, mark it featured</p>
    </div>
...
<div class="max-w-3xl">
    <div class="bg-white rounded-xl shadow-sm border border-gray-100">
        ...
        <form method="POST" action="{{ route('admin.skills.store') }}" enctype="multipart/form-data" class="p-4 lg:p-6 space-y-6">
            @csrf
