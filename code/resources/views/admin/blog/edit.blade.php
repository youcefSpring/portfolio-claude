...
<div class="flex flex-col lg:flex-row lg:justify-between lg:items-start gap-4 mb-6 lg:mb-8">
    ...
    <div class="flex gap-2">
        <a href="{{ route('admin.blog.show', $blog) }}" class="inline-flex items-center justify-center px-4 py-2 border border-blue-300 text-blue-700 text-sm font-medium rounded-lg hover:bg-blue-50 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-colors">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
        ...
        <div class="lg:col-span-1 space-y-6">
            ...
            <div class="flex flex-col gap-3">
                ...
                <a href="{{ route('admin.blog.show', $blog) }}" class="inline-flex items-center justify-center px-4 py-2 border border-gray-300 text-gray-700 text-sm font-medium rounded-lg hover:bg-gray-50 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-colors">
                    Cancel
                </a>
            </div>
        </div>
