...
<div class="flex flex-col lg:flex-row lg:justify-between lg:items-start gap-4 mb-6 lg:mb-8">
    <div class="flex-1">
        <h1 class="text-2xl lg:text-3xl font-bold text-gray-900 mb-2">Edit Blog Post</h1>
        <p class="text-gray-600">{{ $blogPost->title }}</p>
    </div>
    <div class="flex gap-2">
        <a href="{{ route('admin.blog.show', $blogPost) }}" class="inline-flex items-center justify-center px-4 py-2 border border-blue-300 text-blue-700 text-sm font-medium rounded-lg hover:bg-blue-50 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-colors">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
        ...
        <div class="lg:col-span-1 space-y-6">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="flex items-center mt-3">
                                <input type="checkbox" class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
                                       name="remove_featured_image" id="remove_featured_image">
                                <label class="ml-2 text-sm text-gray-700" for="remove_featured_image">
            ...
            <div class="flex flex-col gap-3">
                ...
                <a href="{{ route('admin.blog.show', $blogPost) }}" class="inline-flex items-center justify-center px-4 py-2 border border-gray-300 text-gray-700 text-sm font-medium rounded-lg hover:bg-gray-50 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-colors">
                    Cancel
                </a>
            </div>
        </div>
